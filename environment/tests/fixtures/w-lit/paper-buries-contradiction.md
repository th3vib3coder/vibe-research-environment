# Synthetic Paper Fixture - Buried Conflict
...
```json paperAssertion
{
  "id": "PAPER-ASSERTION-W-LIT-BURIED-001",
  "kind": "claim",
  "syntheticFixture": true,
  "notBiomedicalEvidence": true,
  "runtimeOpened": false,
  "text": "Synthetic fixture assertion: the prose reports a conflict after controlling toy covariates, but this assertion intentionally carries no structured edge stub.",
  "cites": [
    "raw/w-lit/synthetic/paper-buries-contradiction.md"
  ]
}
```
