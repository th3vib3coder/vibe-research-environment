...
export const PHASE10_PATHS = {
  ...
  wikiR2Audit: 'environment/phase10/wiki-r2-audit.js',
  wikiR2AuditValidator: 'environment/tests/ci/phase10-wiki-r2-audit.js',
  wikiR2AuditTest: 'environment/tests/ci/phase10-wiki-r2-audit.test.js',
  assertionGraph: 'environment/phase10/assertion-graph.js',
  assertionGraphValidator: 'environment/tests/ci/phase10-assertion-graph.js',
  assertionGraphTest: 'environment/tests/ci/phase10-assertion-graph.test.js',
  ...
  crossDomainQuery: 'environment/phase10/cross-domain-query.js',
  crossDomainQueryValidator: 'environment/tests/ci/phase10-cross-domain-query.js',
  crossDomainQueryTest: 'environment/tests/ci/phase10-cross-domain-query.test.js',
...
const REQUIRED_FILES = [
  ...
  PHASE10_PATHS.wikiR2Audit,
  PHASE10_PATHS.wikiR2AuditValidator,
  PHASE10_PATHS.wikiR2AuditTest,
  PHASE10_PATHS.assertionGraph,
  PHASE10_PATHS.assertionGraphValidator,
  PHASE10_PATHS.assertionGraphTest,
  ...
  PHASE10_PATHS.crossDomainQuery,
  PHASE10_PATHS.crossDomainQueryValidator,
  PHASE10_PATHS.crossDomainQueryTest,
...
const REQUIRED_PACKAGE_SCRIPTS = {
  ...
  'phase10:cross-domain-query': 'phase10-cross-domain-query.js',
