  ...
  try {
    await writeFixtureFile(vreRoot, 'package.json', JSON.stringify({
      ...
      scripts: {
        ...
        'phase10:cross-domain-query': 'node environment/tests/ci/phase10-cross-domain-query.js',
...
test('phase10-ledger check covers source-bundle registration surfaces in trace reconciliation', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    await assert.rejects(
      () => checkPhase10Ledger({
        repoRoot: vreRoot,
...
test('phase10-ledger check covers knowledge-base import surfaces in trace reconciliation', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    await assert.rejects(
      () => checkPhase10Ledger({
        repoRoot: vreRoot,
...
test('phase10-ledger check covers compile-policy surfaces', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    for (const changedFile of [
      'environment/phase10/compile-policy.js',
      'environment/tests/ci/phase10-compile-policy.js',
...
test('phase10-ledger check covers wiki-query surfaces', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    for (const changedFile of [
      'environment/phase10/wiki-query.js',
      'environment/tests/ci/phase10-wiki-query.js',
...
test('phase10-ledger check covers export-guard surfaces', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    for (const changedFile of [
      'environment/phase10/export-guard.js',
      'environment/tests/ci/phase10-export-guard.js',
...
test('phase10-ledger check covers presentation staleness surfaces', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    for (const changedFile of [
      'environment/phase10/presentation-staleness.js',
      'environment/tests/ci/phase10-presentation-staleness.js',
...
test('phase10-ledger check covers multi-domain gate surfaces', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    for (const changedFile of [
      'environment/phase10/multi-domain-gate.js',
      'environment/tests/ci/phase10-multi-domain-gate.js',
...
test('phase10-ledger check covers cross-domain query boundary surfaces', async () => {
  await withFixtureWorkspace(async ({ workspaceRoot, vreRoot }) => {
    for (const changedFile of [
      'environment/phase10/cross-domain-query.js',
      'environment/tests/ci/phase10-cross-domain-query.js',
