...
(hat3-accepted-pending-commit). This task keeps README and WIKI status generated
...
(hat3-accepted-pending-commit). Questo task mantiene README e WIKI generati da una
